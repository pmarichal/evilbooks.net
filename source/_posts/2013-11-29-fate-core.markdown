...
Le chapitre 6 parle du système à proprement parlé. Comment utiliser les compétences, avec les 4 actions possibles (surmonter (*overcome*), créer un avantage, attaquer et défendre) et les 4 résultats possibles (échec avec la possibilité de réussir au prix fort, égalité et réussir avec un prix mineur, succès, succès avec style). Tous peut se réduire à ces quatre actions et ces quatre résultats, ce qui facilitent grandement le travail du MJ.
